  ...
  return (
    <footer className="relative overflow-hidden">
      ...
      <div className="relative h-20 md:h-28 bg-white">
        <svg className="absolute bottom-0 left-0 right-0 w-full" viewBox="0 0 1440 80" preserveAspectRatio="none" fill="none">
          <path d="M0 40C240 80 480 0 720 40C960 80 1200 0 1440 40V80H0V40Z" fill="url(#footerGrad)" />
          <defs>
      ...
      <div
        ...
        style={{
          background: "linear-gradient(180deg, rgba(14,165,233,0.08) 0%, rgba(14,165,233,0.15) 40%, rgba(7,89,133,0.2) 100%)",
        }}
      >
        {/* Ambient blobs */}
        ...
        <div className="sparkle absolute bottom-[30%] left-[35%]" style={{ width: 1.5, height: 1.5, "--dur": "3.5s", "--delay": "0.5s" } as React.CSSProperties} />
        <div className="sparkle absolute top-[40%] right-[15%]" style={{ width: 2, height: 2, "--dur": "2.8s", "--delay": "1.5s" } as React.CSSProperties} />
            ...
            >
              <div className="relative rounded-[31px] bg-white/95 backdrop-blur-2xl overflow-hidden">
                ...
                <div className="relative h-20 overflow-hidden">
                  <div className="absolute inset-0" style={{ background: "linear-gradient(135deg, #e0f2fe 0%, #bae6fd 50%, #e0f2fe 100%)" }} />
                  <div className="absolute inset-0 opacity-10" style={{
                    backgroundImage: "radial-gradient(circle at 30% 50%, white 1px, transparent 1px), radial-gradient(circle at 70% 40%, white 0.5px, transparent 0.5px)",
                    backgroundSize: "24px 24px, 16px 16px",
                  }} />
                  {/* Curved bottom */}
                  <svg className="absolute bottom-0 left-0 right-0 w-full" viewBox="0 0 400 20" preserveAspectRatio="none">
                    <path d="M0 20 C100 0 300 0 400 20 L400 20 L0 20 Z" fill="white" fillOpacity="0.95" />
                  </svg>
                </div>
                  ...
                  >
                    ...
                    <div
                      ...
                      style={{
                        ...
                        boxShadow: "0 6px 20px rgba(14,165,233,0.3), inset 0 1px 0 rgba(255,255,255,0.2)",
                      }}
                    >
                ...
                <div className="px-8 md:px-12 pb-7 text-center">
                  ...
                  <h4 className="font-heading text-2xl md:text-3xl font-extrabold leading-snug whitespace-nowrap">
                    <span className="text-gradient-hero">Gia đình bé {BABY.name}</span>
                  </h4>

                  {/* Signature-style underline */}
                  <div className="mt-3 flex items-center justify-center">
                    <svg className="w-32 md:w-40 h-3 text-sky-300/40" viewBox="0 0 160 12" fill="none">
                      <path d="M4 8 C30 2 50 10 80 6 C110 2 130 10 156 4" stroke="currentColor" strokeWidth="1.5" strokeLinecap="round" />
                    </svg>
                  </div>
                </div>
              </div>
