        ...
        <div data-aos="flip-up" data-aos-delay="200">
          <div className="relative rounded-[32px] p-[1.5px] save-date-border overflow-hidden">
            <div className="relative rounded-[31px] bg-white/95 overflow-hidden">
              ...
              <div className="h-28 md:h-36 relative overflow-hidden rounded-tl-[31px] rounded-tr-[31px]">
                <div
                  className="absolute inset-0"
                  style={{
                    background:
                      "linear-gradient(135deg, #e0f2fe 0%, #bae6fd 30%, #7dd3fc 60%, #38bdf8 100%)",
                  }}
                />
                {/* Pattern overlay */}
                <div
                ...
                <svg
                  className="absolute bottom-0 left-0 right-0 h-16 text-white/15"
                  viewBox="0 0 400 60"
              ...
              <div className="px-6 md:px-10 pb-8 pt-6 text-center">
                ...
                <a
                  ...
                  style={{
                    ...
                    boxShadow:
                      "0 8px 25px rgba(14,165,233,0.35), inset 0 1px 0 rgba(255,255,255,0.2)",
                  }}
                >
                  {/* Button shimmer */}
                  <div className="shimmer-sweep" />
