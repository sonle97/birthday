...
export default function CalendarSection() {
  ...
  return (
    <section className="relative py-14 md:py-20 px-4 overflow-hidden bg-gradient-to-b from-white via-bg-primary to-white">
              ...
              <div className="px-4 md:px-6 pb-6 pt-2">
                ...
                <div className="grid grid-cols-7 gap-0.5 mb-1">
                  {DAYS_OF_WEEK.map((day) => (
                    <div
                      key={day}
                      className="font-heading text-[10px] font-bold text-sky-500 uppercase py-2 text-center"
                    >
                      {day}
                    </div>
                  ))}
                    ...
                    <div
                      ...
                      className={`relative py-2 font-body text-sm rounded-xl cursor-default transition-colors duration-200 ${
                        day === HIGHLIGHT_DAY
                          ...
                          : "text-text-primary/75 hover:bg-sky-50 hover:text-sky-600"
                      }`}
                    >
                      {day === HIGHLIGHT_DAY ? (
                        <>
              ...
              <div className="relative flex items-center">
                ...
                <div className="flex items-center gap-1.5 md:gap-2 px-3 md:px-7 py-4">
                  ...
                  <div className="text-center">
                    <p className="font-heading text-[9px] font-bold text-sky-500/80 uppercase tracking-wider mb-0.5">Ngày</p>
                  ...
                  {/* Month */}
                  <div className="text-center">
                    <p className="font-heading text-[9px] font-bold text-sky-500/80 uppercase tracking-wider mb-0.5">Tháng</p>
                  ...
                  {/* Year */}
                  <div className="text-center">
                    <p className="font-heading text-[9px] font-bold text-sky-500/80 uppercase tracking-wider mb-0.5">Năm</p>
                    <div className="w-12 h-12 md:w-14 md:h-14 rounded-xl bg-sky-50/80 border border-sky-100/60 flex items-center justify-center">
                ...
                <div className="hidden md:flex flex-col items-center justify-center px-5 py-4">
                  ...
                  <p className="font-heading text-[9px] font-bold text-sky-600/70 uppercase tracking-wider mt-0.5">{EVENT.year}</p>
                </div>
              </div>
            </div>
          </div>
